...
import com.nowbook.rlt.TestConstants;
...
public class DepositFeeServiceTest extends BaseServiceTest {
    ...
    public void testCreateWithError() {
        // 用户没有权限
        Response<Long> actual = depositFeeService.create(new DepositFee(), TestConstants.SELLER);
        ...
        actual = depositFeeService.create(creating, TestConstants.ADMIN);
    ...
    public void testCreateWithNoAccount() {
        ...
        Response<Long> actual = depositFeeService.create(creating, TestConstants.ADMIN);
    ...
    public void testUpdateWithError() {
        ...
        Response<Long> actual = depositFeeService.update(depositFee, TestConstants.SELLER);
        assertThat(actual.getError(), is("user.has.no.permission"));

        // 没传id
        DepositFee updating = new DepositFee();
        actual = depositFeeService.update(updating, TestConstants.ADMIN);
    ...
    public void testUpdateIncrement() {
        ...
        Response<Long> actual = depositFeeService.update(updating, TestConstants.ADMIN);
        assertThat(actual.isSuccess(), is(Boolean.TRUE));
    ...
    public void testFindDepositDetailByName() {
        // 用户无权限
        Response<Paging<DepositFee>> actual = depositFeeService.findDepositDetailByName("seller2", null, null, null, TestConstants.SELLER);
        assertThat(actual.getResult().getTotal(), is(0L));
        assertThat(actual.getResult().getData().size(), is(0));

        // 商户可以查询自己
        TestConstants.SELLER.setId(1L);
        TestConstants.SELLER.setName("seller1");

        actual = depositFeeService.findDepositDetailByName(null, null, 0, 10, TestConstants.SELLER);
        assertThat(actual.getResult().getTotal(), is(1L));
        assertThat(actual.getResult().getData().size(), is(1));


        // admin 可以查指定商户
        actual = depositFeeService.findDepositDetailByName("seller3", null, 0, 10, TestConstants.ADMIN);
        assertThat(actual.getResult().getTotal(), is(2L));
        assertThat(actual.getResult().getData().size(), is(2));


        // 可以查指定行业
        actual = depositFeeService.findDepositDetailByName(null, 2L, 0, 10, TestConstants.ADMIN);
    ...
    public void testFindTechFeeDetailByName() {
        // 用户无权限
        Response<Paging<DepositFee>> actual = depositFeeService.findTechFeeDetailByName("seller2", null, null, null, TestConstants.SELLER);
        assertThat(actual.getResult().getTotal(), is(0L));
        assertThat(actual.getResult().getData().size(), is(0));
        ...
        actual = depositFeeService.findTechFeeDetailByName(null, null, 0, 10, TestConstants.SELLER);
        assertThat(actual.getResult().getTotal(), is(1L));
        assertThat(actual.getResult().getData().size(), is(1));


        // admin 可以查指定商户
        actual = depositFeeService.findTechFeeDetailByName("seller3", null, 0, 10, TestConstants.ADMIN);
        assertThat(actual.getResult().getTotal(), is(2L));
        assertThat(actual.getResult().getData().size(), is(2));


        // 可以查指定行业
        actual = depositFeeService.findTechFeeDetailByName(null, 2L, 0, 10, TestConstants.ADMIN);
        assertThat(actual.getResult().getTotal(), is(3L));
        assertThat(actual.getResult().getData().size(), is(3));
    }
    ...
    public void testFindBaseDetailByName() {
        // 用户无权限
        Response<Paging<DepositFee>> actual = depositFeeService.findBaseDetailByName(null, null, TestConstants.NONTYPE);
        assertThat(actual.getResult().getTotal(), is(0L));
        assertThat(actual.getResult().getData().size(), is(0));
        ...
        TestConstants.SELLER.setId(1L);
        TestConstants.SELLER.setName("seller1");
        actual = depositFeeService.findBaseDetailByName(null, null, TestConstants.SELLER);
        assertThat(actual.getResult().getTotal(), is(1L));
        assertThat(actual.getResult().getData().size(), is(1));
    }
