...
-- 优惠码
DROP TABLE IF EXISTS `nb_coupons`;
...
DROP TABLE IF EXISTS `nb_coupons_area`;
...
DROP TABLE IF EXISTS `nb_coupons_user_order`;
...
DROP TABLE IF EXISTS `nb_coupons_user_order_items`;
...
DROP TABLE IF EXISTS `nb_coupons_users`;
