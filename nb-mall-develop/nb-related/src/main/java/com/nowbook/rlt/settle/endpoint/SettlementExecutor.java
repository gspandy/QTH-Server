package com.nowbook.rlt.settle.endpoint;

import com.nowbook.rlt.settle.enums.JobType;
import com.nowbook.rlt.settle.manager.JobManager;
import com.nowbook.rlt.settle.model.SettleJob;
import com.google.common.base.Objects;
import com.google.common.util.concurrent.ThreadFactoryBuilder;
import com.nowbook.rlt.settle.handle.*;
...
//                return;
//            }
            if (Objects.equal(jobType, JobType.PAY_EARNINGS_BONUSES)) {
                finishHandle.payEarningsBonuses(settleJob);
                return;
            }

            if (Objects.equal(jobType, JobType.CREAT_SETTLEMENTS)) {
                finishHandle.createSettlements(settleJob);
                return;
            }
            ...
            if (Objects.equal(jobType, JobType.SUM_EARNINGS_BONUSES)) {
                finishHandle.sumEarningsBonuses(settleJob);
                return;
            }
...
//                rateUpdateHandle.updateNbRate(settleJob);
//                return;
//            }
