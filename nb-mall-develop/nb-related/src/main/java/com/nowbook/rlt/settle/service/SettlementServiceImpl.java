...
import com.nowbook.alipay.dto.AlipaySettlementResponse;
import com.nowbook.alipay.dto.settlement.AlipaySettlementDto;
import com.nowbook.alipay.request.PageQueryRequest;
...
import com.nowbook.rlt.settle.dao.AlipayTransDao;
import com.nowbook.rlt.settle.dao.ItemSettlementDao;
import com.nowbook.rlt.settle.dao.SettlementDao;
import com.nowbook.rlt.settle.dto.FatSettlement;
import com.nowbook.rlt.settle.manager.DepositManager;
...
import com.nowbook.rlt.settle.util.SettlementVerification;
...
import static com.nowbook.common.utils.Dates.endOfDay;
import static com.nowbook.common.utils.Dates.startOfDay;
import static com.nowbook.rlt.settle.util.SettlementVerification.checkOrderStatus;
import static com.nowbook.user.util.UserVerification.*;
...
public class SettlementServiceImpl implements SettlementService {
     ...
     * @return 操作是否成功
     * @see  SettlementVerification#checkOrderStatus
     */
    ...
    private Long newSettlement(Long orderId, Boolean multi) {
        ...
        settlement.setConfirmedAt(new Date());
...
//        Double rate = 0.0000;
//        if(order.getPaymentPlatform().equals("3")){
//            rate = Double.valueOf(systemConfRedisDao.getDate("alipay_exchange_rate"))/100;
//        }
        ...
        // 默认未结算状态
        settlement.setSettleStatus(Settlement.SettleStatus.FINISH.value());
