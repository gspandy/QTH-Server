...
import com.nowbook.rlt.predeposit.dao.*;
...
import com.nowbook.rlt.predeposit.manager.PreDepositManager;
import com.nowbook.rlt.predeposit.model.DepositAddressStorage;
import com.nowbook.rlt.predeposit.model.DepositStorageStock;
...
public class PreDepositServiceImpl implements PreDepositService {
    ...
    public Response<PreOrderPreDeposit> preOrderPreDeposit(String skus, Integer regionId, BaseUser baseUser) {
        ...
        try {
            ...
            fops.setIsEnb(Objects.equal(eNbSellerId,shop.getUserId().toString())); //是否是enb商家
