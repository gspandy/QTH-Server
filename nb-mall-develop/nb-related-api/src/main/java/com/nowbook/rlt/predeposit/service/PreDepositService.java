package com.nowbook.rlt.predeposit.service;
...
import com.nowbook.rlt.predeposit.dto.FullItemPreDeposit;
import com.nowbook.rlt.predeposit.dto.PreOrderPreDeposit;
import com.nowbook.rlt.predeposit.model.PreDeposit;
import com.nowbook.rlt.predeposit.dto.MarketItem;
...
public interface PreDepositService {
     ...
     * @return 预售
     */
    Response<PreDeposit> findById(Long id);

    /**
     * 创建预售，同时创建商品，sku
     * @param preDeposit preDeposit
     * @return 是否操作成功
     */
    Response<Boolean> create(PreDeposit preDeposit, BaseUser user);
     ...
     * @return 操作是否成功
     */
    Response<Boolean> update(PreDeposit preDeposit, BaseUser user);
     ...
     */
    @SuppressWarnings("unused")
    Response<FullItemPreDeposit> findFullItemPreDeposit(@ParamInfo("itemId") Long itemId);
     ...
     */
    Response<PreOrderPreDeposit> preOrderPreDeposit(@ParamInfo("skus") String skus,
     ...
     * @param fatOrderPreDeposit fatOrderPreDeposit
     * @return 是否创建成功
     */
    Response<Long> createPreDepositOrder(Long buyerId, Long tradeInfoId, Integer regionId, FatOrderPreDeposit fatOrderPreDeposit,
     ...
     * @return preSale
     */
    Response<PreDeposit> findPreDepositByItemId(Long itemId);
     ...
     * @return 是否移除成功
     */
    Response<Boolean> removePreDepositOrder(Long orderId);

    /**
     * 判断预售商品订单是否过期
     */
    Response<Boolean> verifyPreDepositOrderExpire();

    /**
     * 判断预售商品是否过期
     */
    Response<Boolean> verifyPreDepositExpire();
     ...
     * @return  是否成功
     */
    Response<Boolean> recoverPreDepositStorageIfNecessary(Long orderId);
     ...
     * @return 是否成功
     */
    Response<Boolean> recoverPreDepositBuyLimitIfNecessary(Order order);
     ...
     * @return  对应的预售
     */
    Response<PreDeposit> findByItemId(Long itemId);
