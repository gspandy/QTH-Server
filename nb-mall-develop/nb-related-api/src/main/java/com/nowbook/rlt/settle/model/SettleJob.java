...
public class SettleJob implements Serializable {
     ...
     * 周三发放奖金和收益
     */
    public static SettleJob payEarningsBonuses(Date doneAt, Date tradedAt) {
        return new SettleJob(JobType.PAY_EARNINGS_BONUSES.value(), doneAt, tradedAt);
    }
    /**
     * 周末结算奖金和收益
     */
    public static SettleJob sumEarningsBonuses(Date doneAt, Date tradedAt) {
        return new SettleJob(JobType.SUM_EARNINGS_BONUSES.value(), doneAt, tradedAt);
    }
    /**
     * 创建结算数据
     */
    public static SettleJob createSettlements(Date doneAt, Date tradedAt) {
        return new SettleJob(JobType.CREAT_SETTLEMENTS.value(), doneAt, tradedAt);
    }
     ...
     * 补系统帐务
     */
    public static SettleJob levelUp(Date doneAt, Date tradedAt) {
        return new SettleJob(JobType.FIX_SETTLEMENT.value(), doneAt, tradedAt);
    }
