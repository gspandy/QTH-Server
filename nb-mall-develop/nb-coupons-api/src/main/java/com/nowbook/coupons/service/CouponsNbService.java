 ...
 */
public interface CouponsNbService {
    int adminCount();
    Response<List<NbCou>> queryCouponsBy(Long userId);
    ...
    Response<NbCou> queryCouponsById(@ParamInfo("couponsId") Long couponsId);

    /**
     * 修改优惠券信息
     * **/
    Response<Boolean> updateNbCou(NbCou nbCou);

    /**
     *下订单页面判断数据显示 根据当前sku和 baseuser
     * **/
    Response<List<NbCouUserView>> preCouponsBySku(@ParamInfo("skus") String skus,@ParamInfo("baseUser") BaseUser baseUser);
     ...
     * @return              分页结果
     */
    Response<Paging<NbCou>> findCouponsByPaging(@ParamInfo("businessId") int businessId,@ParamInfo("status") String status,@ParamInfo("pageNo") Integer pageNo,@ParamInfo("count") Integer count);
    /**
     * 添加优惠券
     * @param paramMap
     * @return 操作是否成功
    ...
    //根据优惠券查询列表
    Response<NbCouUser> queryCouponsUserBy(Long userId,Long couponsId);
     ...
     * @return shopDto
     */
    Response<Paging<NbCou>> queryCouponsByPage(@ParamInfo("businessId") Long businessId,
 ...
 * ****/
    Response<List<NbCou>> querySellerCouponsByParam(@ParamInfo("baseUser") BaseUser baseUser,
	 ...
	 * @return
	 */
    Response<Paging<NbCou>> queryCouponsByShopId(@ParamInfo("sellerId") Long shopId,@ParamInfo("pageIndex") Long pageIndex,@ParamInfo("pageSize") Long pageSize);

    /**
     * 根据优惠券ID查询优惠券信息
     * **/

    Response<NbCou> queryShopCouponsById(@ParamInfo("couponsId") Long couponsId);
     ...
     * **/
    Response<Paging<NbCou>> queryNbCouponsByPage(@ParamInfo("baseUser") BaseUser baseUser,
