...
public interface AccountService<T extends BaseUser> {
     ...
     * @return 是否更新成功
     */
    Response<Boolean> changePassword(Long userId, String oldPassword, String newPassword,String type);
     ...
     * @return 是否重置成功
     */
    Response<Boolean> resetPassword(Long userId, String password,String type);
     ...
     * @return 用户
     */
    Response<T> WxLogin(String id, LoginType type, String password);
    ...
    Response<Long> findByOpenId(String openId);
