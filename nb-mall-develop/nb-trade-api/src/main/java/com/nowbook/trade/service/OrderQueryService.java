...
import com.nowbook.trade.dto.ItemBundlePreOrder;
import com.nowbook.trade.dto.OrderDescription;
import com.nowbook.trade.dto.OrderItemTotalFee;
import com.nowbook.trade.dto.RichOrderBuyerView;
import com.nowbook.trade.dto.RichOrderItem;
import com.nowbook.trade.dto.RichOrderSellerView;
import com.nowbook.trade.dto.RichOrderWithDetail;
...
public interface OrderQueryService {
     ...
     * @param pageNo             页码
     * @param size               返回条数
     * @param finishedStartAt     创建起始时间
     * @param finishedEndAt       创建截止时间
     * @return 订单列表
     */
    ...
    Response<Paging<RichOrderBuyerView>> findByBuyerId(@ParamInfo("baseUser") BaseUser baseUser,
                                                       ...
                                                       @ParamInfo("status") Integer status,
                                                       @ParamInfo("orderId") Long orderId,
                                                       @ParamInfo("distributorId") Long distributorId);

    Response<Paging<RichOrderBuyerView>> findByBuyerIdForNS(BaseUser baseUser, Integer pageNo,
     ...
     * @return  更新的订单列表
     */
    Response<Paging<NbOrder>> findNbOrderByUpdatedAt(Date beginAt, Date endAt, List<Long> businesses,
     ...
     * @return  更新的订单列表
     */
    Response<Paging<NbOrder>> findNbOrderByUpdatedAtAndSellerIds(Date beginAt, Date endAt, List<Long> businesses,
     ...
     * @return      订单
     */
    Response<NbOrder> findNbOrderById(Long id);
