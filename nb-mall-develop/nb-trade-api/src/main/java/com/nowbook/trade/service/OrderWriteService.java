...
import com.nowbook.trade.dto.ItemBundleFatOrder;
import com.nowbook.trade.dto.OrderIdAndEarnestId;
import com.nowbook.trade.dto.OrderLogisticsInfoDto;
...
public interface OrderWriteService{
     ...
     * @return 更改是否成功
     */
    void updateNbOrderItem(OrderItem orderItems);
