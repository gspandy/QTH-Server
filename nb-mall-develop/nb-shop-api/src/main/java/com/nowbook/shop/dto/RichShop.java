...
public class RichShop implements Serializable, Indexable{
    ...
    @Getter
    @Setter
    private Integer rExpress = 0;       //物流评价

    @Getter
    @Setter
    private Integer rService = 0;       //服务评价

    @Getter
    @Setter
    private Integer rDescribe = 0;      //描述评价

    @Getter
    @Setter
    private Integer rQuality = 0;       //质量评价
}
