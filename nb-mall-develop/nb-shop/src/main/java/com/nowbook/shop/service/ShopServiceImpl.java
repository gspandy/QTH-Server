...
import com.nowbook.shop.dao.ShopDao;
import com.nowbook.shop.dao.ShopExtraDao;
import com.nowbook.shop.dao.ShopPaperworkDao;
import com.nowbook.shop.dao.redis.ShopRedisDao;
import com.nowbook.shop.dto.RichShop;
import com.nowbook.shop.dto.ShopDto;
import com.nowbook.shop.dto.ShopInfoDto;
import com.nowbook.shop.dto.ShopSidebar;
import com.nowbook.shop.event.ApprovePassEvent;
import com.nowbook.shop.event.ShopEventBus;
import com.nowbook.shop.manager.ShopManager;
import com.nowbook.shop.model.Shop;
import com.nowbook.shop.model.ShopExtra;
import com.nowbook.shop.model.ShopPaperwork;
...
import com.nowbook.arrivegift.model.Weekday;
...
/**
 * Author: <a href="mailto:jl@nowbook.com">jl</a> Date: 2013-10-28
 */
@Service
@Slf4j
public class ShopServiceImpl implements ShopService {
	...
	public Response<ShopInfoDto> findByUser(BaseUser user) {
		...
		try {
			...
			// 是否是enb商家
			shopInfoDto.setIsEnb(Objects.equal(eNbSellerId, shop
					.getUserId().toString()));
	...
	public Response<Paging<RichShop>> searchShop(int pageNo, int size,
		...
		try {
			...
			Paging<RichShop> shopP = esClient.search(SHOP_INDEX_TYPE, RichShop.class, requestBuilder);
			if (shopP.getTotal() == 0) {
	...
	public HashMap<String, String> getShopEvaluationMap(final long shopId) {
		HashMap<String, String> resultMap = shopRedisDao.getShopEvaluationMap(shopId);
		return resultMap;
	}
}
