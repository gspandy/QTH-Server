...
import com.nowbook.category.service.CategoryService;
...
public class CouponsController {
    ...
    public Response<String> searchCoupons(@RequestParam("shopAcc") String shopAcc,@RequestParam("channel") String channel,@RequestParam("status") String statuss,@RequestParam("shopName") String shopName,@RequestParam("pageCount") int pageCount){
        int count = couponsNbService.adminCount();
        ...
        if(list!=null&&list.size()!=0){
            for(Map map :list){
                ...
                String tempType="1".equals(map.get("channelId").toString())?"家电":"2".equals(map.get("channelId").toString())?"家具":"3".equals(map.get("channelId").toString())?"家装":"4".equals(map.get("channelId").toString())?"家饰":"5".equals(map.get("channelId").toString())?"净水":"6".equals(map.get("channelId").toString())?"NB广场":"获取频道错误";
	...
	public void addCoupon(HttpServletRequest request) {
		...
		couponsNbService.addCoupon(paramMap);
	}
	...
	public List<Map<String, Object>> findCategory(
		...
		List<Map<String, Object>> map = couponsNbService
	...
	public void updateCouponStatus(@RequestParam("id") Integer id,
		...
		paramMap.put("id", id);
		couponsNbService.updateCouponStatus(paramMap);
	}
