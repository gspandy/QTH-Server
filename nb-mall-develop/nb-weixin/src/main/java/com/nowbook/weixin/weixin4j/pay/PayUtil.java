...
public class PayUtil {
     ...
     * @return 支付对象
     */
    public static WCPay getBrandWCPayRequest(String appId, String prepay_id, String paternerKey,String partnerId) {
        //初始化支付对象
        return new WCPay(appId, prepay_id, paternerKey,partnerId);
    }
