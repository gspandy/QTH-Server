...
import com.nowbook.item.dao.mysql.ItemDetailDao;
...
public class ItemManager {
    ...
    public void update(Item item, ItemDetail itemDetail, List<Sku> skus) {
        ...
        for (Sku sku : skus) {
            ...
            toUpdate.setQuasiAngelPrice(sku.getAngelPrice());
            toUpdate.setAngelPrice(sku.getAngelPrice());
            toUpdate.setGoldPrice(sku.getGoldPrice());
            toUpdate.setPlatinumPrice(sku.getPlatinumPrice());
            toUpdate.setBlackPrice(sku.getBlackPrice());
            toUpdate.setPartnerPrice(sku.getPartnerPrice());
            toUpdate.setComPrice(sku.getPartnerPrice());
            toUpdate.setPriceType(sku.getPriceType());
            toUpdate.setPurchasePrice(sku.getPurchasePrice());
            toUpdate.setSellingPrice(sku.getSellingPrice());
            toUpdate.setCustomPrice(sku.getCustomPrice());
            toUpdate.setAngelRecommendPrice(sku.getAngelRecommendPrice());
