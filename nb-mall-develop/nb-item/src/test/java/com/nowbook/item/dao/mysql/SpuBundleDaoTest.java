package com.nowbook.item.dao.mysql;

import com.nowbook.common.model.Paging;
import com.nowbook.item.BaseDaoTest;
...
public class SpuBundleDaoTest extends BaseDaoTest {
    ...
    public void testOnOff(){
        spuBundleDao.create(spuBundle);
        Assert.assertEquals(spuBundleDao.findById(spuBundle.getId()).getStatus().intValue(), SpuBundle.Status.ON.value());
        spuBundleDao.onOff(spuBundle.getId(), SpuBundle.Status.OFF);
        Assert.assertEquals(spuBundleDao.findById(spuBundle.getId()).getStatus().intValue(), SpuBundle.Status.OFF.value());
