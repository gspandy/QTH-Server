...
//                       result = smsService.sendSingle("000000", mobile,"SMS_4040003", message);
    ...
    public Boolean changePassword(String oldPassword, String newPassword) {
        ...
        Response<Boolean> result = accountService.changePassword(userId, oldPassword, newPassword,"1");
        if (result.isSuccess()) {
            return result.getResult();
        } else {
    ...
    public String handleForgotPasswordByMobile(@RequestParam("mobile") String mobile, @RequestParam("password") String password,
        ...
        Response<Boolean> r = accountService.resetPassword(user.getId(), password,"1");
        if (r.isSuccess()) {
            return "ok";
        } else {
