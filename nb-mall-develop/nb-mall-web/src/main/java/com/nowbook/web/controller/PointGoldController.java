...
import com.nowbook.web.utils.RSAToBCDCoder;
...
//    #获取用户点击金币接口url
    ...
    @Getter
    @Setter
    private String showGoldKey = "client_nb";
...
//        ?api=userpointstotal&query={"id":"12000099"}&sign=c74391dcbbb3566309b649bce5c4e6ef
        if(baseUser!=null){
            ...
            //http://nbnbdev.oceanus-data.com/api/v1/points?api=userpointstotal&query={%22id%22:%2212000099%22}&sign=c74391dcbbb3566309b649bce5c4e6ef
//            根据地址获取积分加密数据
