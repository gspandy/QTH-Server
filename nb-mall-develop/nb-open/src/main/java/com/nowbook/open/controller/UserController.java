...
public class UserController {
    ...
    public Response<Boolean> sendSms(@RequestParam(value="id", defaultValue = "1") Long id,
        ...
        try {
            ...
            // 渠道 NB PAD 只能使用默认的短信接口，这里负责生成验证码(手机验证码登陆的安全问题)
    ...
    @ResponseBody
    public NbResponse<Long> login(@RequestParam("loginId") String loginId,
    ...
    public NbResponse<Boolean> forgetPassword(@RequestParam("mobile") String mobile,
        ...
        try {
            ...
            Response<Boolean> resetPassResult = accountService.resetPassword(user.getId(), password,"1");
