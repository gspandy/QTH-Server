...
import com.nowbook.trade.model.OrdersPopularize;
...
public class TradeController {
    ...
    @ResponseBody
    public Response<Paging<NbOrder>> ordersPage(@RequestParam(value="channel", required = true) String channel,
        ...
        try {
            ...
            Response<Paging<NbOrder>> ordersQuery = orderQueryService
                    .findNbOrderByUpdatedAtAndSellerIds(beginAt, endAt, bussinessIdsResult.getResult(), pageNo, size, userIds);
