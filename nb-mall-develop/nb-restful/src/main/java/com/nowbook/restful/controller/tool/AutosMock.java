package com.nowbook.restful.controller.tool;
...
import com.nowbook.trade.dto.NbOrderItem;
...
public class AutosMock {
    ...
    @ResponseBody
    public NbResponse<Boolean> orderSync(@RequestParam(value = "orderId") String orderId,
    ...
    @ResponseBody
    public NbResponse<NbOrder> order(@RequestParam(value = "orderId") String orderId,
                                      @RequestParam(value = "sign") String sign) {
    ...
    private NbOrder orderMock() {
        NbOrder dto = new NbOrder();
        ...
        item1.setQuantity(1);
        item1.setFee(300000);
        item1.setItemName("锦霖彩电");

        NbOrderItem item2 = new NbOrderItem();
        item1.setQuantity(1);
        item1.setFee(200000);
        item1.setItemName("锦霖冰箱");

        List<NbOrderItem> items = Lists.newArrayList(item1, item2);
        dto.setItems(items);
        return dto;
    }
    ...
    private Paging<NbOrder> mock(){
        Paging<NbOrder> paging = new Paging<NbOrder>();
        NbOrder dto = new NbOrder();
        ...
        List<NbOrderItem> items = Lists.newArrayList(item1, item2);
        dto.setItems(items);
        List<NbOrder> dtos = Lists.newArrayList(dto, dto);
