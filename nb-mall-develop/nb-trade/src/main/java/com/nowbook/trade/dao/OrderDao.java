...
public class OrderDao extends SqlSessionDaoSupport {
    ...
    /**
     * 根据订单状态status统计各个状态的数量
     * @author dpzh
     * @create 2017/7/24 16:23
     * @param id  买家id
     * @return  各种状态对应的数量  订单状态 0：待付款，1：待发货，2：待收货，3：退换货（4，5，6,-3,-4），4：已完成（3）
     */
    public List<Order> countStatus(Long id) {
        return getSqlSession().selectList("Order.countStatus", id);
    }
