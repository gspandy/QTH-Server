...
CREATE INDEX `idx_nb_comment_item` ON nb_comments(item_id);
CREATE INDEX `idx_nb_comment_order` ON nb_comments(order_item_id);
CREATE INDEX `idx_nb_comment_buyer` ON nb_comments(buyer_id);
CREATE INDEX `idx_nb_comment_shop` ON nb_comments(shop_id);
